 ...
 */
const Header5 = ({ children, className }) => {
    const headerClassPrefix = {
        [index_module_scss_1.default[`${index_1.prefix}-header--5`]]: true,
    };
    const headerClasses = (0, classnames_1.default)(className, headerClassPrefix);
    return (0, jsx_runtime_1.jsx)("h5", Object.assign({ className: headerClasses }, { children: children }));
};
exports.default = Header5;
//# sourceMappingURL=Header5.js.map